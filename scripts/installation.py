...
def create_config(data):
    ...
    config = {
        ...
        #             "http://mirror.fsrv.services/archlinux/$repo/os/$arch",
        #             "https://mirror.fsrv.services/archlinux/$repo/os/$arch",
        #             "https://mirror.gnomus.de/$repo/os/$arch",
        #             "http://www.gutscheindrache.com/mirror/archlinux/$repo/os/$arch",
        ...
        #             "http://mirror.orbit-os.com/archlinux/$repo/os/$arch",
        ...
        #             "http://mirror.satis-faction.de/archlinux/$repo/os/$arch",
        ...
        #             "http://mirror.undisclose.de/archlinux/$repo/os/$arch",
