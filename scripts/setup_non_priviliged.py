...
def install_yay():
    ...
    cmd = 'git clone https://aur.archlinux.org/yay'
    subprocess.run("arch-chroot -u admin:admin /mnt/archinstall sudo -i -u admin /bin/bash -c 'git clone https://github.com/drkkvbs/base'" % cmd,
                   shell=True)
